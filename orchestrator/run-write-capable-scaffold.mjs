...
const pathPolicy = createPathPolicy({
  forbiddenPathPatterns: FORBIDDEN_PATH_PATTERNS,
  scopePathAllowlists: SCOPE_PATH_ALLOWLISTS,
  scopes: WRITE_SCOPES,
});
const matchesPathPattern = matchesRepoPathPattern;
const uniqueSorted = uniqueSortedRepoPaths;

export const normalizeRepoPath = normalizeCoreRepoPath;
export const isUnsafePathShape = isUnsafeRepoPathShape;
export const validateScope = pathPolicy.validateScope;
export const isForbiddenPath = pathPolicy.isForbiddenPath;
...
export function createWriteCapableThreadOptions(options = {}) {
  return createThreadOptionsFromContract(WRITE_CAPABLE_THREAD_OPTION_CONTRACT, options);
}
