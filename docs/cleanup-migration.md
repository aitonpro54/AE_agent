...
`AE_agent_clean` создан как новая чистая рабочая копия AE Agent. Старый проект
`C:\Users\Ant\Documents\Codex\AE_agent` остается историческим источником и
архивом доказательств.
