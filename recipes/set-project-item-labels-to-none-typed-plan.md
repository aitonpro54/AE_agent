...
- The user asks to set project item labels to none or clear Project panel labels.
...
- Do not use this recipe for label defaults by type, Project panel
  selection reads, item rename, item movement, cleanup/deletion, filesystem
  operations, filesystem operations, render queue work, proxy state, folder traversal, or raw
  ExtendScript.
