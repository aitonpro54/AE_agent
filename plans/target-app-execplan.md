...
`inspect`/provider readiness and panel task-window budget, and a narrow
...
selected-keyframe marker, fill-in/current-expression keyframe tails,
render-queue setup, remaining project/file/proxy and user-file lanes,
third-party semantics lanes, and remaining tail `full-ui-agent-*openai-cli-smoke`
commands. Do not rerun the completed
layer/path/EG/Puppet/composition-marker/project-item-metadata/comp-current-time/
selected-property-value/selected-property-keyframe/text-to-keys waves unless
