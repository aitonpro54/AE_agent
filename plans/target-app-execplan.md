...
- Planner guidance, plan-repair aliases, semantic verification, solution-library guidance, and generated-only live validation for `duplicate_layers` remain separate queue items after the runtime slice.
