...
async function main() {
  ...
  if (queuedToolResponses.length !== 21 || queuedToolResponses.some((item) => item.response.status !== 200 || !item.response.body.ok)) {
