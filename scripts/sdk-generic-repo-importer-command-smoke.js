...
function validManifest(fixture, runId = "aux015-valid") {
  return {
    ...
    targetRepo: {
      path: fixture.target,
      allowedWritePaths: ["orchestrator/**", "scripts/**", "docs/current-state/generic-repo-importer/**"],
...
function assertValidRunArtifacts(output, fixture, runId) {
  ...
  assert.strictEqual(normalized._meta.sourceContractPath.endsWith("generic-repo-importer-contract.json"), true);
