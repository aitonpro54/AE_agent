...
- The visible product title format is `AE Agent 1.0.1` in the native CEP title/menu only; do not duplicate the product name in a separate in-panel top bar or sidebar heading.
